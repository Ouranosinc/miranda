...
__all__ = ["aggregate_hourly_nc_files", "convert_hourly_ec_files"]
...
def convert_hourly_ec_files(
    ...
    rep_nc = Path(output_folder).joinpath("split/{}".format(variable_name))
    ...
    for fichier in list_files:
        ...
        for code in l_codes:
            ...
            logging.info("Traitement de {} pour station {}".format(variable_name, code))
